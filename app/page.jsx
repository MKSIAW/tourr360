...
const Welcome = ({ user }) => {
  return (
    <div>
      ...
      <div className="welcome-container text-center text-gray-800 mt-8">
        <main>
          <h2 className="text-4xl font-bold mb-16">Where to?</h2>
          <div className="flex justify-center space-x-8 mb-10">


            <Link href="/things-to-do">
              <div className="text-2xl hover:text-black-500 hover:underline transition duration-300 ease-in-out flex items-center">
  ...
  <div className="relative">
    <input
      type="search"
      placeholder="Search for places to go, things to do, hotels..."
...
<div className="placeholder-container text-center mt-20">
  <div className="placeholder bg-gray-0 p-4 w-250 mx-40 relative rounded-xl">
    ...
    <div className="absolute bottom-10 left-10 w-full text-left">
      <h2 className="text-3xl font-bold text-white font-arial mb-1">World's Best Hotels for 2021</h2>
